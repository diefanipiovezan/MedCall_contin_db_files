                ...
                <div class="row">
                    <div class="col-md-10 col-md-offset-1">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="txtCidadeNova" />
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-10 col-md-offset-1">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="txtBairroNovo" />
                        </div>
                    </div>
                </div>
            </div>
...
<div class="form-group">
    ...
    <div class="col-md-5">
        <input type="text" class="form-control" name="txtLogradouro" placeholder="Ex.: Rua Tom Jobim" required />
    </div>
</div>
<div class="form-group">
    <label for="txtNumero" class="col-md-2 control-label">Número</label>
    <div class="col-md-2">
        <input type="number" class="form-control" name="txtNumero" />
    </div>
</div>
<div class="form-group">
    <label for="txtCep" class="col-md-2 control-label">CEP</label>
    <div class="col-md-2">
        <input type="number" class="form-control" name="txtCep" />
    </div>
</div>
<div class="form-group">
