...
<div class="form-group">
    ...
    <div class="col-md-3">
        <input type="text" class="form-control" name="txtUsuario" placeholder="usuário" maxlength="20" required />
    </div>
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <div class="col-md-3">
        <input type="password" class="form-control" name="txtSenhaConfirma" placeholder="digite a senha novamente" required />
    </div>
</div>
